...
import {
  ...
  parametres, unites, mouvementsStock,
} from './schema';
  ...
  await db.insert(mouvementsStock).values([
    {
      ...
      stockAvant: 0,
      stockApres: 15,
      motif: 'Stock initial livraison fournisseur Tech Distribution',
      utilisateurId: 'u1',
    ...
    },
    {
      ...
      stockAvant: 0,
      stockApres: 10,
      motif: 'Livraison initiale Bureau Plus',
      utilisateurId: 'u2',
      utilisateurNom: 'Marie Ndiaye',
    ...
    },
    {
      ...
      stockAvant: 15,
      stockApres: 13,
      motif: 'Vente client CMD-2026-001',
      utilisateurId: 'u2',
      utilisateurNom: 'Marie Ndiaye',
    ...
    },
    {
      ...
      tenantId: DEFAULT_TENANT_ID,
      produitId: 'p3',
      produitNom: 'Clavier Mécanique Sans Fil',
      produitRef: 'ELEC-003',
      type: 'usage_interne',
      quantite: 1,
      stockAvant: 25,
      stockApres: 24,
      motif: 'Équipement poste de travail comptabilité',
      utilisateurId: 'u1',
      utilisateurNom: 'Jean Dupont',
    ...
    },
    {
      ...
      tenantId: DEFAULT_TENANT_ID,
      produitId: 'p4',
      produitNom: 'Chaise Ergonomique de Bureau',
      produitRef: 'MOB-001',
      type: 'ajustement',
      quantite: 8,
      stockAvant: 10,
      stockApres: 8,
      motif: 'Inventaire physique - régularisation casse',
      utilisateurId: 'u3',
    ...
    },
    {
      ...
      stockAvant: 10,
      stockApres: 15,
      motif: 'Réapprovisionnement stock du jour',
      utilisateurId: 'u1',
    ...
    },
    {
      ...
      stockAvant: 10,
      stockApres: 9,
      motif: 'Vente Caisse Ticket TIC-2026-0015',
      utilisateurId: 'u2',
