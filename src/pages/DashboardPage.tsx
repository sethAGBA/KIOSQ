...
export default function DashboardPage() {
  ...
  }, [commandes, factures, clients, produits]);
    ...
    <div className="space-y-6 max-w-7xl">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <KpiCard
          ...
          value={formatPrice(kpis.montantEnAttente)}
          sub={`${kpis.facturesEnAttente} facture(s) non soldée(s)`}
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <KpiCard
          ...
          value={formatPrice(mockDataCA.reduce((s, d) => s + d.benefice, 0))}
          sub="sur 12 mois"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="card p-5 lg:col-span-2">
          <div className="flex items-center justify-between mb-4">
            ...
            >
              {formatPrice(mockDataCA.reduce((s, d) => s + d.valeur, 0))}
            </div>
          </div>
          <ResponsiveContainer width="100%" height={200}>
            <AreaChart data={mockDataCA} margin={{ top: 5, right: 5, left: 0, bottom: 0 }}>
              <defs>
        ...
        <div className="card p-5">
          ...
          <ResponsiveContainer width="100%" height={200}>
            <BarChart data={mockDataCA} margin={{ top: 5, right: 5, left: 0, bottom: 0 }}>
